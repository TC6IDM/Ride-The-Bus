...
export default {
	...
	'Enter a number of plays': 'Syötä pelien määrä',
	...
	'Colour — red or black for card 1.': 'Väri — punainen vai musta kortille 1.',
	...
	'Pick all four, set your bet, and hit Spin. Each correct guess multiplies your win; a wrong guess ends the round but you keep whatever you had banked so far. Guess all four to win the full game.':
		'Valitse kaikki neljä, aseta panoksesi ja paina Pelaa. Jokainen oikea arvaus kertoo voittosi; väärä päättää kierroksen, mutta pidät siihen mennessä turvatun summan. Arvaa kaikki neljä oikein saadaksesi täyden voiton.',
	...
	'Ace is low and King is high — worth knowing, since plenty of card games play it the other way. Suit never affects rank; only the number counts for Higher / Lower and Inside / Outside.':
		'Ässä on pienin ja kuningas suurin — hyvä tietää, sillä monissa korttipeleissä se on toisin päin. Maa ei koskaan vaikuta järjestykseen; Suurempi / Pienempi ja Välissä / Ulkopuolella katsovat vain lukuarvoa.',
	Lowest: 'Pienin',
	Highest: 'Suurin',
	...
	'Spins must be %s seconds apart': 'Kierrosten välillä on oltava %s sekuntia',
