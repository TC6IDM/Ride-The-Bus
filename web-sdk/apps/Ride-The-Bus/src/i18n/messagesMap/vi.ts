// Vietnamese. Keys are the English source strings - see en.ts.
export default {
	HOME: 'TRANG CHỦ',

	Balance: 'Số dư',
	'Last Win': 'Thắng gần nhất',
	Bet: 'Cược',
	...
	'Inside, outside, or equal': 'Ở giữa, ngoài khoảng hoặc bằng nhau',
	'Pick a suit': 'Chọn chất',
	Red: 'Đỏ',
	Black: 'Đen',
	Equal: 'Bằng nhau',
	...
	Unmute: 'Bật tiếng',
	'How to play': 'Cách chơi',
	'Choose bet amount': 'Chọn mức cược',
	'Custom bet amount': 'Mức cược tùy chỉnh',
	...
	'That bet was rejected. Please adjust the amount and try again.':
		'Mức cược đó bị từ chối. Vui lòng điều chỉnh số tiền và thử lại.',
	...
	'This game is not available from your location.':
		'Trò chơi này không khả dụng tại vị trí của bạn.',
	'The game server had a problem. Please try again shortly.':
		'Máy chủ trò chơi gặp sự cố. Vui lòng thử lại sau giây lát.',
	'The game is under maintenance. Please try again shortly.':
		'Trò chơi đang bảo trì. Vui lòng thử lại sau giây lát.',
	'Skip the reveal': 'Bỏ qua phần lật bài',
	'Session information': 'Thông tin phiên',
	'Net Position': 'Lãi/lỗ ròng',
	RTP: 'RTP',
	Session: 'Phiên',
	Fast: 'Nhanh',
	'Number of plays': 'Số vòng',
