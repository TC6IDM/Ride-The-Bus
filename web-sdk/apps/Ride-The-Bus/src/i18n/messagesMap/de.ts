...
export default {
	...
	'Stop autoplay on full game win': 'Autoplay bei Komplettgewinn stoppen',
	...
	'Plus and minus set your bet. Tap the amount for the quick-bet menu.':
		'Plus und Minus legen deinen Einsatz fest. Tippe auf den Betrag für das Schnelleinsatz-Menü.',
	'The speaker opens the sound settings. Music and game sounds mute separately.':
		'Der Lautsprecher öffnet die Toneinstellungen. Musik und Spielgeräusche lassen sich getrennt stummschalten.',
	...
	'Guess whether card 3 lands between cards 1 and 2, outside them, or equal to either. After Equal on step 2 there is nothing to fall between, so Inside is unavailable.':
		'Tippe, ob Karte 3 zwischen Karte 1 und 2 liegt, außerhalb, oder einer von beiden gleicht. Nach Gleich in Schritt 2 gibt es nichts, was dazwischen liegen könnte, also ist Innen nicht wählbar.',
	'Guess the suit of card 4: hearts, diamonds, clubs or spades.':
		'Errate das Symbol von Karte 4: Herz, Karo, Kreuz oder Pik.',
