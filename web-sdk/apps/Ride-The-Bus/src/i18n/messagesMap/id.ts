// Indonesian. Keys are the English source strings - see en.ts.
export default {
	HOME: 'BERANDA',
	...
	'Two Equal picks — averages 1329.2×, up to 1354.2×, the most this game can pay.':
		'Dua Sama — rata-rata 1329,2×, hingga 1354,2×, pembayaran tertinggi permainan ini.',
	...
	'Inside, outside, or equal': 'Di antara, di luar, atau sama',
	'Pick a suit': 'Pilih jenis',
	Red: 'Merah',
	Black: 'Hitam',
	Equal: 'Sama',
	...
	'How to play': 'Cara bermain',
	'Choose bet amount': 'Pilih jumlah taruhan',
	'Custom bet amount': 'Jumlah taruhan khusus',
	'Increase bet': 'Naikkan taruhan',
	...
	'That bet was rejected. Please adjust the amount and try again.':
		'Taruhan itu ditolak. Sesuaikan jumlahnya dan coba lagi.',
	...
	'This game is not available from your location.':
		'Permainan ini tidak tersedia dari lokasi Anda.',
	'The game server had a problem. Please try again shortly.':
		'Server permainan mengalami masalah. Silakan coba lagi sebentar lagi.',
	'The game is under maintenance. Please try again shortly.':
		'Permainan sedang dalam pemeliharaan. Silakan coba lagi sebentar lagi.',
	'Skip the reveal': 'Lewati pembukaan kartu',
