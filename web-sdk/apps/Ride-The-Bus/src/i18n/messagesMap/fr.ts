// French. Keys are the English source strings - see en.ts.
export default {
	HOME: 'ACCUEIL',
	...
	'Higher / Lower — versus card 1 (or =).': 'Plus haut / Plus bas — par rapport à la carte 1 (ou =).',
	...
	'One Equal pick — averages 67.5×, up to 381.9×.':
		'Un Égal — en moyenne 67,5×, jusqu\'à 381,9×.',
	...
	'Inside, outside, or equal': 'Entre, hors ou égal',
	'Pick a suit': 'Choisir une enseigne',
	Red: 'Rouge',
	Black: 'Noir',
	Equal: 'Égal',
	'Not possible after guessing Equal': 'Impossible après avoir choisi Égal',
	Heart: 'Cœur',
	Diamond: 'Carreau',
	Club: 'Trèfle',
	Spade: 'Pique',
	...
	'How to play': 'Comment jouer',
	'Choose bet amount': 'Choisir le montant de la mise',
	'Custom bet amount': 'Montant personnalisé',
	...
	'That bet was rejected. Please adjust the amount and try again.':
		'Cette mise a été refusée. Ajustez le montant et réessayez.',
	...
	'This game is not available from your location.':
		'Ce jeu n\'est pas disponible depuis votre position.',
	'The game server had a problem. Please try again shortly.':
		'Le serveur de jeu a rencontré un problème. Veuillez réessayer sous peu.',
	'The game is under maintenance. Please try again shortly.':
		'Le jeu est en maintenance. Veuillez réessayer sous peu.',
	'Skip the reveal': 'Passer la révélation',
	...
	Fast: 'Rapide',
	'Number of spins': 'Nombre de tours',
	'Unlimited spins': 'Tours illimités',
	'More spins': 'Plus de tours',
	'Fewer spins': 'Moins de tours',
	...
	'Return to player (RTP) is %s. Every combination of guesses costs 1x your bet and returns that same figure over many rounds. The most this game can pay is 1354.2x your bet.':
		'Le taux de retour au joueur (RTP) est de %s. Chaque combinaison de pronostics coute 1x votre mise et restitue ce meme taux sur un grand nombre de tours. Le gain maximal de ce jeu est de 1354,2x votre mise.',
	'Disclaimer':
		'Avertissement',
	'Malfunction voids all wins and plays. A consistent internet connection is required. In the event of a disconnection, reload the game to finish any uncompleted rounds. The expected return is calculated over many plays. The game display is not representative of any physical device and is for illustrative purposes only. Winnings are settled according to the amount received from the Remote Game Server and not from events within the web browser. TM and (c) 2026 Stake Engine.':
		'Tout dysfonctionnement annule les gains et les parties. Une connexion internet stable est requise. En cas de deconnexion, rechargez le jeu pour terminer les tours non acheves. Le retour attendu est calcule sur un grand nombre de parties. L affichage du jeu ne represente aucun appareil physique et sert uniquement d illustration. Les gains sont regles selon le montant recu du Remote Game Server et non selon les evenements du navigateur. TM et (c) 2026 Stake Engine.',	'Loading replay…': 'Loading replay…',
	'Max Win': 'Max Win',
