// Korean. Keys are the English source strings - see en.ts.
export default {
	HOME: '홈',
	...
	'Inside, outside, or equal': '사이, 바깥 또는 이퀄',
	'Pick a suit': '무늬 선택',
	Red: '빨강',
	Black: '검정',
	Equal: '이퀄',
	...
	Unmute: '음소거 해제',
	'How to play': '게임 방법',
	'Choose bet amount': '베팅 금액 선택',
	'Custom bet amount': '직접 입력한 베팅 금액',
	'Increase bet': '베팅 금액 올리기',
	...
	'That bet was rejected. Please adjust the amount and try again.':
		'해당 베팅이 거부되었습니다. 금액을 조정한 뒤 다시 시도해 주세요.',
	...
	'The game server had a problem. Please try again shortly.':
		'게임 서버에 문제가 발생했습니다. 잠시 후 다시 시도해 주세요.',
	'The game is under maintenance. Please try again shortly.':
		'게임이 점검 중입니다. 잠시 후 다시 시도해 주세요.',
	'Skip the reveal': '공개 건너뛰기',
	...
	'Malfunction voids all wins and plays. A consistent internet connection is required. In the event of a disconnection, reload the game to finish any uncompleted rounds. The expected return is calculated over many plays. The game display is not representative of any physical device and is for illustrative purposes only. Winnings are settled according to the amount received from the Remote Game Server and not from events within the web browser. TM and © 2026 Stake Engine.':
		'오작동 시 모든 당첨과 플레이가 무효가 됩니다. 안정적인 인터넷 연결이 필요합니다. 연결이 끊긴 경우 게임을 다시 불러와 완료되지 않은 라운드를 마치십시오. 기대 환수율은 다수의 플레이를 기준으로 계산됩니다. 게임 화면은 실제 기기를 나타내지 않으며 예시용입니다. 당첨금은 웹 브라우저 내의 이벤트가 아니라 Remote Game Server에서 수신한 금액에 따라 정산됩니다. TM 및 © 2026 Stake Engine.',
