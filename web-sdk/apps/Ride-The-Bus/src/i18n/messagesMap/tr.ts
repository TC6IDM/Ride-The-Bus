...
export default {
	...
	'Enter a number of plays': 'Tur sayısını girin',
	...
	'Replays cannot be re-bet': 'Tekrarlara yeniden bahis yapılamaz',
	...
	'Stop autoplay on full game win': 'Tam oyun kazancında otomatik oyunu durdur',
	...
	'Plus and minus set your bet. Tap the amount for the quick-bet menu.':
		'Artı ve eksi bahsinizi belirler. Hızlı bahis menüsü için tutara dokunun.',
	'The speaker opens the sound settings. Music and game sounds mute separately.':
		'Hoparlör ses ayarlarını açar. Müzik ve oyun sesleri ayrı ayrı kapatılır.',
	...
	'Guess whether card 3 lands between cards 1 and 2, outside them, or equal to either. After Equal on step 2 there is nothing to fall between, so Inside is unavailable.':
		'Kart 3’ün kart 1 ile 2 arasında mı, dışında mı yoksa ikisinden birine eşit mi olacağını tahmin edin. 2. adımda Eşit seçildikten sonra araya girebilecek kart kalmaz, bu yüzden İçinde seçilemez.',
	'Guess the suit of card 4: hearts, diamonds, clubs or spades.':
		'4. kartın sembolünü tahmin edin: kupa, karo, sinek veya maça.',
	'You guessed Equal, so cards 1 and 2 share a rank. Nothing can fall between them, so Inside cannot win.':
		'Eşit seçtiniz, yani 1. ve 2. kartlar aynı değerde. Aralarına hiçbir şey giremez, bu yüzden İçinde kazanamaz.',
