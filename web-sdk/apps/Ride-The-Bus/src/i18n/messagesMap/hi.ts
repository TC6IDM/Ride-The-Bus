// Hindi. Keys are the English source strings - see en.ts.
export default {
	HOME: 'होम',
	...
	'Inside, outside, or equal': 'बीच में, बाहर या बराबर',
	'Pick a suit': 'सूट चुनें',
	Red: 'लाल',
	Black: 'काला',
	Equal: 'बराबर',
	...
	Unmute: 'ध्वनि चालू',
	'How to play': 'कैसे खेलें',
	'Choose bet amount': 'दांव राशि चुनें',
	'Custom bet amount': 'अपनी दांव राशि',
	'Increase bet': 'दांव बढ़ाएं',
	...
	'Something went wrong. Please try again.': 'कुछ गड़बड़ हुई। कृपया पुनः प्रयास करें।',
	'That bet was rejected. Please adjust the amount and try again.':
		'वह दांव अस्वीकृत हो गया। कृपया राशि बदलकर पुनः प्रयास करें।',
	...
	'The game is under maintenance. Please try again shortly.':
		'गेम रखरखाव में है। कृपया थोड़ी देर में पुनः प्रयास करें।',
	'Skip the reveal': 'कार्ड खोलना छोड़ें',
	...
	'Loading Ride The Bus…': 'Ride The Bus लोड हो रहा है…',
	'Max Win': 'अधिकतम जीत',
