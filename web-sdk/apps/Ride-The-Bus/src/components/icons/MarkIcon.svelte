<script lang="ts">
	 ...
	 * U+2193, the up and down arrows, but not the right one in between. So
	 * every one of those characters fell straight through the webfont to whatever
	 * the device substitutes - which on Android and iOS is routinely a colour emoji,
