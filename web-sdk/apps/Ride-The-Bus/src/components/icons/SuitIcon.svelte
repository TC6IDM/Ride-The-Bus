<script lang="ts">
	 ...
	 * (Poppins then, Barlow now - neither owns them). That is a font dependency
	 * for the most important glyphs in a card game, and the font does not
	 * actually own them - they fall through to whatever the device
