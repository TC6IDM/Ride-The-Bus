---
name: accessibility
description: Audit and improve web accessibility against WCAG 2.2. Use for a11y audits, WCAG compliance, screen readers, keyboard navigation, contrast or touch targets.
license: MIT
metadata:
