...
description: Programmatic UI sound design with the Web Audio API and Tone.js: clicks, chimes, toggles, hover, success/error, whoosh, and sound libraries. Includes a browser preview harness and Web Audio validation rules (context lifetime, node cleanup, gain envelopes).
license: MIT
metadata:
